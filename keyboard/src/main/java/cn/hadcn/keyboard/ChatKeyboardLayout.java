...
public class ChatKeyboardLayout extends SoftHandleLayout implements EmoticonsToolBarView.OnToolBarItemClickListener {
    ...
    public final static String RIGHT = "0";
    ...
    public ChatKeyboardLayout(Context context, AttributeSet attrs) {
        ...
        orientation = typedArray.getString(R.styleable.ChatKeyboardLayout_orientation);
        initView(context);
        typedArray.recycle();
    }
    ...
    private void initView(Context context) {
        ...
        if (!LEFT.equals(orientation)) {
            ...
            LayoutInflater.from(context).inflate(R.layout.view_keyboardbar_left, this);
        }
